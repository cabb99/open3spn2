...
DihedralStyle(list,DihedralList)

#else

#ifndef LMP_DIHEDRAL_LIST_H
#define LMP_DIHEDRAL_LIST_H
...
class DihedralList : public Dihedral {
 public:
  DihedralList(class LAMMPS *);
  virtual ~DihedralList();
 ...
 protected:
  double *kperiodic, *kgauss, *phi,  *sigm, *style;
