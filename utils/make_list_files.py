...
class LmpConf:
    ...
    def write_bond_list(self):
        ...
        for i in range(self.nBonds):
            ...
            file.write("%ld\t%ld\t%lf\t%lf\t%lf\t%lf\n" % (b.a,b.b,r,kbond*kJ2kCal,0.0,100*kbond*kJ2kCal))
        file.close()

    def write_angle_list(self):
        ...
        for i in range(self.nAngles):
            ...
            if a.type == 1:
                file.write("%ld\t%ld\t%ld\t%lf\t%lf\n" % (a.a,a.b,a.c,theta,kbend*kJ2kCal))
        file.close()

    def write_dihedral_list(self):
        ...
        for i in range(self.nDihedrals):
            ...
            file.write("%ld\t%ld\t%ld\t%ld\t%lf\t%lf\t%lf\t%lf\t%d\n" % (d.a,d.b,d.c,d.d,phi,kperiodic*kJ2kCal, kgauss*kJ2kCal, sigma, dihedral_type))
        file.close()
...
def get_command_line_args(args):
    if len(args) != 2:
        print "Usage: %s <LAMMPS configuation file>" % args[0]
        sys.exit(1)
    return args[1]
...
def main():
    ...
    lmpconf.write_bond_list()
    lmpconf.write_angle_list()
    lmpconf.write_dihedral_list()
